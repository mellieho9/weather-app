    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                ...
                WeatherDayView(dayOfWeek: "THU", imageName: "wind.snow", temperature: 65)
...
struct MainWeatherStatusView : View {
    ...
    var body: some View {
        VStack (spacing: 10) {
            ...
            Text("\(temperature)").font(.system(size: 70, weight: .medium, design: .default)).foregroundColor(.white)
        }.padding(.bottom, 40)
...
struct WeatherButton : View {
    ...
    var body: some View {
        Text(title).frame(width: 280, height: 50).background(backgroundColor).font(.system(size: 20, weight: .bold, design: .default)).cornerRadius(10)
